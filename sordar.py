...
os.system("espeak \"Follow My page\"")
print ('\033[0;101m🌺𝙁𝙤𝙡𝙡𝙤𝙬 𝙈𝙮 𝙥𝙖𝙜𝙚✅\033[0m\n')
os.system('xdg-open https://www.facebook.com/100088316394289');time.sleep(1)
...
\033[1;39m     ┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙉𝘼𝙈𝙀\033[1;34m        : [★] 𝗦𝗔𝗝𝗝𝗔𝗗-𝗦𝗢𝗥𝗗𝗔𝗥\033[1;39m            ┃
\033[1;39m     ┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙁𝘼𝘾𝙀𝘽𝙊𝙊𝙆\033[1;34m    : [★] 𝗦𝗔𝗝𝗝𝗔𝗗 𝗦𝗢𝗥𝗗𝗔𝗥[1;39m   ┃
\033[1;39m     ┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙂𝙄𝙏𝙃𝙐𝘽\033[1;34m      : [★] sᴀᴊᴊᴀᴅ-sᴏʀᴅᴀʀ[1;39m          ┃
\033[1;39m     ┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙍𝙄𝙇𝙄𝙂𝙀𝙎𝙃𝙊𝙉\033[1;34m  : [★]ʙᴀɴɢʟᴀᴅᴇsʜ\033[1;39m        ┃
\033[1;39m     ┃ \x1b[1;95m❣︎[𖣘]☔︎\x1b[1;96m𝙒𝙃𝘼𝙏𝙎𝘼𝙋𝙋\033[1;34m    : [★]+88014015****SORRY\033[1;39m     ┃
...
def xxr():
  ...
  #  print(lov)   
   ...
   #name=input("\x1b[38;5;207m𝗨𝗦𝗘𝗥 𝗡𝗔𝗠𝗘 : \033[1;92m")
    os.system("clear")
    #os.system("espeak \"Wall come sir,NOOV-404 Random Cloning Enter your country code\"")
    print(logo)
  #print("\033[1;92m〠〠〠〠〠〠〠〠〠〠〠〠〠〠〠〠〠〠〠〠〠〠〠\033[0m\n")
       
    print('′\033[0;101m 𝐄𝐍𝐓𝐄𝐑 𝐘𝐎𝐔𝐑 𝐂𝐎𝐔𝐍𝐓𝐑𝐘 𝐂𝐎𝐃𝐄 \033[0m\n')   
  #print("\033[1;31m〠〠〠〠〠〠〠〠〠〠〠〠〠〠〠〠〠〠〠〠〠〠〠\033[0m")
    print('[𝗕𝗗 𝗖𝗢𝗗𝗘] \033[1;92m> \033[1;92m017 - 019 - 018 - 015')
    code = input('\033[1;92m𝐂𝐇𝐎𝐎𝐒𝐄 𝐂𝐎𝐔𝐍𝐓𝐑𝐘 𝐂𝐎𝐃𝐄 : ')
    os.system('clear')
    print(logo)
  #print("\033[1;31m〠〠〠〠〠〠〠〠〠〠〠〠〠〠〠〠〠〠〠〠〠〠〠\033[0m")
  ...
  #print("\033[1;92m〠〠〠〠〠〠〠〠〠〠〠〠〠〠〠〠〠〠〠〠〠〠〠\033[0m")
    ...
    os.system('xdg-open https://facebook.com/groups/baiman.cyber.official/')
    ...
    with ThreadPool(max_workers=40) as KING:
        ...
        tl = str(len(user))
       # print(lov)       
       print(f"\033[1;92m[\033[1;34m✔\033[1;92m]\033[0;92m𝗡𝗔𝗠𝗘           \033[1;34m: \033[0;97m"+name)
        print(f"\033[1;92m[\033[1;34m✔\033[1;92m]\033[0;92m𝗔𝗚𝗘𝗡𝗧𝗦         \033[1;34m: \033[0;34m"+str(len(ugen5)))
        print(f"\033[1;92m[\033[1;34m✔\033[1;92m]\033[0;92m𝗖𝗥𝗔𝗖𝗞 𝗜𝗗       \033[1;34m: \033[0;97m"+tl+" ")
        print(f"\033[1;92m[\033[1;34m✔\033[1;92m]\033[0;92m𝗦𝗜𝗠 𝗖𝗢𝗗𝗘       \033[1;34m: \033[0;97m"+code)
        print(f"\033[1;92m[\033[1;34m✔\033[1;92m]\033[0;92m𝗦𝗧𝗔𝗥𝗧 𝗧𝗜𝗠𝗘     \033[1;34m: \033[0;97m{ha}/{bu}/{ta} ~ {GREEN} "+str(a)+":"+str(lt()[4])+" "+ tag+" ")
        print('\033[1;92m═━═━═━═━═━━═━═━══━═━═━═━═━━═━═━══━═━═━ ')
        for love in user:
